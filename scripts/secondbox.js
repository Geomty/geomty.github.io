...
function changeSecondBoxColor() {
    if (boolean) {
        ...
        fadeBgColor();
        $("body").css("transition", "background-color 0.3s ease-in-out");
        document.getElementById("seconddescription").innerHTML = "<br>I'm a (beginner) developer who codes in HTML, CSS, and JavaScript. I didn't know what else to put here, so click this text for a surprise.";
        boolean = true;
    }
}